# Django settings for crguide project.
...
SECRET_KEY = '((-d-6)@cowu@l(up9uyk0*=np3ulp+5f6eo5+z66!r^aanfkw'
...
ROOT_URLCONF = 'crguide.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'crguide.wsgi.application'

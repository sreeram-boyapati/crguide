...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'questions_question', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offices.Office'])),
        ...
        db.create_table(u'questions_answer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('answer_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questions.Question'])),
            ('answered_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
    ...
    models = {
        ...
        u'questions.answer': {
            ...
            'answer_to': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['questions.Question']"}),
            'answered_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'questions.question': {
            'Meta': {'object_name': 'Question'},
            'asked_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['offices.Office']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
